...
This directory contains the GoalFinder project's technical documentation and contribution guidance.
...
See the [contribution guide](./contribute/README.md) for detailed instructions on how to use the provided GitHub development tools. 