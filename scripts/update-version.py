...
def update_webapp_version(version: str, git_hash: str = "unknown"):
    """Update the version.ts file in the web app with the new version."""
    repo_root = Path(__file__).resolve().parent.parent
    version_ts_path = repo_root / "client" / "web" / "src" / "version.ts"

    content = f"""// This file is auto-generated by scripts/update-version.py during release builds.
// Do not edit manually.

export const APP_VERSION = "{version}";
export const GIT_COMMIT_HASH = "{git_hash}";
"""

    version_ts_path.write_text(content)
    print(f"Updated {version_ts_path} to version {version}")
...
def main():
    ...
    update_webapp_version(version, git_hash)
